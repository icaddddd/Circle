...
export class MyMigration1699541636995 implements MigrationInterface {
    name = 'MyMigration1699541636995'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "threads" ("id" SERIAL NOT NULL, "posted_at" TIMESTAMP NOT NULL DEFAULT now(), "content" character varying NOT NULL, "image" character varying NOT NULL, "userId" integer, CONSTRAINT "PK_d8a74804c34fc3900502cd27275" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "users" ("id" SERIAL NOT NULL, "username" character varying NOT NULL, "fullname" character varying, "password" character varying NOT NULL, "email" character varying NOT NULL, "picture" character varying, "description" character varying, CONSTRAINT "PK_a3ffb1c0c8416b9fc6f907b7433" PRIMARY KEY ("id"))`);
