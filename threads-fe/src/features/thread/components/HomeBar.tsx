    ...
    <form onSubmit={handlePost} encType="multipart/form-data">
        <FormControl>
            <Box display={"flex"} gap={3}>
              <Input name="content" onChange={handleContentChange} type='text' placeholder="what's on ur mind?" />
              <Box mt={3}>
                <Input name="image" onChange={handleImageChange} mt={2} type='file' border={"none"} display={"none"} id="input-image" />
